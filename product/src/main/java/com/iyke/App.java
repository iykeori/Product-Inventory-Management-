...
public class App {
  ...
  static void testSales() {
    ...
    sale.setProduct(ps.findBy(UUID.fromString("2b183ead-d762-49ae-81f2-85bd8b4b8495")).get());
    sale.setQuantity(10);
  ...
  static void testReturnSales() {
    ...
    rsale.setProduct(ps.findBy(UUID.fromString("2b183ead-d762-49ae-81f2-85bd8b4b8495")).get());
    rsale.setSale(ss.findBy(UUID.fromString("bbfe3329-57be-4217-97f9-c33d87edd915")).get());
